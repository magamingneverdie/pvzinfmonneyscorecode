...
class Sunflower(Plant):
    def __init__(self,x,y):
        ...
        self.rect.y = y
        self.price = 100
        self.hp = 9999999999999999999999999999999999999999999999999999999999999999999999999999
        #5 时间计数器
        self.time_count = 0
...
class PeaBullet(pygame.sprite.Sprite):
    def __init__(self,peashooter):
        ...
        self.damage = 1000000000000000000000000000000000000000000
        self.speed  = 10
        self.rect = self.image.get_rect()
...
class Zombie(pygame.sprite.Sprite):
    def __init__(self,x,y):
        ...
        self.image = pygame.image.load('imgs/zombieback.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
        self.hp = 1
...
class MainGame():
    ...
    score = 100000000000
    remnant_score = 100
    money = 999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999
    #3 存储所有地图坐标点
    map_points_list = []
    #3 存储所有的地图块
    map_list = []
            ...
            if e.type == pygame.QUIT:
                ...
                if e.button == 1:
                    ...
                    if map.can_grow and MainGame.money >= 50:
                        ...
                        print('当前植物列表长度:{}'.format(len(MainGame.plants_list)))
                        map.can_grow = False
                        MainGame.money -= 9999999999999999999999999999999999999999999
